...
for element in list:
   ...
   port = element.device
   command = "/Users/jp/Library/Arduino15/packages/esp8266/tools/esptool/0.4.9/esptool -vv -cd nodemcu -cb 921600 -cp " + port + " -ca 0x00000 -cf " + dir_path + "/sync_animations.ino.bin"
   call(command, shell=True) 
