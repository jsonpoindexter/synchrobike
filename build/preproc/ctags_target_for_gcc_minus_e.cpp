# 1 "/Users/jp/.ghq/github.com/jsonpoindexter/synchrobike/sync_animations/sync_animations.ino"
# 1 "/Users/jp/.ghq/github.com/jsonpoindexter/synchrobike/sync_animations/sync_animations.ino"
//************************************************************
...
//
//************************************************************
# 10 "/Users/jp/.ghq/github.com/jsonpoindexter/synchrobike/sync_animations/sync_animations.ino" 2
...
# 19 "/Users/jp/.ghq/github.com/jsonpoindexter/synchrobike/sync_animations/sync_animations.ino" 2
# 29 "/Users/jp/.ghq/github.com/jsonpoindexter/synchrobike/sync_animations/sync_animations.ino"
CRGB leds[75];
...
//mesh.setDebugMsgTypes( ERROR | MESH_STATUS | CONNECTION | SYNC | COMMUNICATION | GENERAL | MSG_TYPES | REMOTE ); // all types on
  mesh.setDebugMsgTypes( 1 | 1<<1 ); // set before init() so that you can see startup messages
  ...
  FastLED.addLeds<WS2811, 13, GRB>(leds, 75).setCorrection( TypicalLEDStrip );
...
void fillnoise8() {
  ...
  for(int i = 0; i < 75; i++) { // Just ONE loop to fill up the LED array as all of the pixels change.
